...
const content = {
    ja: {
        ...
        news: {
            ...
            items: [
                ...
                { date: "2025-08-07", title: "Asia Science Camp 2025（ASC2025）に参加しました", summary: "ノーベル賞受賞者を含めた数多くの研究者の方やアジア各国からの高校生大学生参加者と交流しました。", fullContent: "2025年7月31日から8月6日にかけてタイで開催された、Asia Science Camp 2025 (ASC2025) に、日本代表団の一員として参加しました。本キャンプは、ノーベル賞受賞者や世界のトップレベルの研究者による講演、そしてアジア各国から選抜された高校生・大学生との交流を通じて、次世代の科学者を育成することを目的とした国際的なプログラムです。\n期間中は、多岐にわたる科学分野の講演聴講に加え、講師や参加者を交えたディスカッション、グループでのポスターセッションに参加しました。各国の参加者との議論を通じて、多様な科学的視点やアプローチに触れることができ、大変有意義な時間となりました。本キャンプで得た国際的な経験と知見を、今後の自身の研究活動に活かしていきたいと考えています。", images: [`${process.env.PUBLIC_URL}/images_news/ASC2025_1.jpg`, `${process.env.PUBLIC_URL}/images_news/ASC2025_2.jpg`, `${process.env.PUBLIC_URL}/images_news/ASC2025_3.jpg`] },
                { date: "2025-08-11", title: "【告知】8月24日に大阪万博クラゲ館にてWSを行います", summary: "植物に関するワークショップを8月24日に大阪・関西万博2025「いのちの遊び場 クラゲ館」にて行います。", fullContent: "来る2025年8月24日（日）、大阪・関西万博のパビリオン「いのちの遊び場 クラゲ館」にて、私が企画・案内するワークショップ『植物と人がともに紡ぐ共生の風景　ー触って学ぶ植物の能力』を開催します。\n\nこの企画は、植物が持つ驚くべき能力を、見て、触れて、直感的に体験していただく参加型のイベントです。会場内には「オジギソウ触れ合い」「就眠運動観察」「電気信号可視化」など、私の研究に基づいた5つのステーションを設置します。参加者の皆様には、これらのステーションを自由に巡りながら植物の神秘を発見し、人と植物が共創する未来のビジョンを一緒に描いていきたいと考えています。\n\n皆様のご来場を心よりお待ちしております。\n\n【開催概要】\n■日時: 2025年8月24日（日） 10:15 - 13:15\n■場所: 大阪・関西万博2025 いのちの遊び場 クラゲ館「いのちのゆらぎ場」\n■参加方法: 予約不要（先着順となります）\n\n※状況により、内容の変更や中止となる可能性があります。予めご了承ください。", "images": [ "/images_news/Expo2025_1.jpg", "/images_news/Expo2025_2.jpg" ] }
            ],
        ...
        map: {
            ...
            locations: [
                ...
                { id: "thailand", name: "タイ", image: `${process.env.PUBLIC_URL}/images/asc2025.png`, details: "「Asia Science Camp 2025」に日本代表団の一員として参加。アジア各国から集まった学生やノーベル賞受賞者と交流し、科学的な議論を通じて国際的な視点と人的な繋がりを深めました。" }
            ]
        },
        activities: {
    ...
    en: {
        nav: { profile: "Profile", vision: "Vision", news: "News", research: "Research", projects: "Projects", map: "Map", activities: "Activities", contact: "Contact" },
        hero: { title: "Kazuhiro Komatsu", subtitle: "A High School Researcher Exploring Plant Intelligence" },
        profile: {
            title: "Profile",
            name: "Kazuhiro Komatsu",
            affiliation: "Suwa Seiryo High School | Vice Director, ADvance Lab",
            description: "Driven by a desire to understand the abilities of plants, I am tackling the challenge of elucidating the stimulus habituation mechanism in the sensitive plant, Mimosa pudica. Alongside my research using deep learning and custom-built devices, I am also passionate about educational activities that convey the wonders of science to the next generation.",
            cv_button: "View CV"
        },
        vision: {
            title: "Vision",
            heading: "Flourish with Flora",
            subheading: "Redesign the world with the OS of life",
            description: "My vision is to unlock the yet-unseen abilities of plants and apply them to society. Plants are far more intelligent than we often realize, possessing remarkable survival strategies and methods of communication. For instance, they can find light and nutrients, defend against pests, and skillfully adapt to environmental changes. I firmly believe that by deeply understanding this hidden intelligence of plants and combining it with cutting-edge technology, we can bring about significant transformations in various fields.",
        },
        news: {
            title: "News",
            items: [
                ...
                { date: "2025-07-11", title: "Presented a Poster at ACMB-JSMB2025", summary: "Presented research findings on the stimulus habituation mechanism of plants at ACMB-JSMB2025.", fullContent: "At ACMB-JSMB2025 (a joint conference of the Asian Conference on Mathematical Biology and the Annual Meeting of the Japanese Society for Mathematical Biology), I presented a poster on my research topic: the stimulus habituation mechanism of Mimosa pudica. This joint conference is an important academic event where cutting-edge research in the field of mathematical biology from across Asia and Japan gathers. During the presentation, I shared new insights obtained through mathematical approaches and model construction regarding how plants adapt to environmental stimuli and change their responses. In particular, it was a very meaningful time to engage in lively discussions with participating researchers about the results of analyzing the stimulus habituation phenomenon, which can be called Mimosa pudica's 'memory,' using mathematical models.", images: [`${process.env.PUBLIC_URL}/images_news/ACMBJSMB1.jpg`, `${process.env.PUBLIC_URL}/images_news/ACMBJSMB2.jpg`] },
                { date: "2025-08-07", title: "Participated in Asia Science Camp 2025 (ASC2025)", summary: "Interacted with numerous researchers, including Nobel laureates, and high school/university students from various Asian countries.", fullContent: "I participated as a member of the Japanese delegation in the Asia Science Camp 2025 (ASC2025), held in Thailand from July 31 to August 6, 2025. This camp is an international program aimed at fostering the next generation of scientists through lectures by Nobel laureates and world-class researchers, as well as exchanges with selected high school and university students from across Asia.\nDuring the camp, I attended lectures in various scientific fields and participated in discussion sessions with lecturers and participants, as well as group poster sessions. Through discussions with participants from different countries, I was able to encounter diverse scientific perspectives and approaches, making it a very meaningful time. I hope to apply the international experience and knowledge gained from this camp to my future research activities.", images: [`${process.env.PUBLIC_URL}/images_news/ASC2025_1.jpg`, `${process.env.PUBLIC_URL}/images_news/ASC2025_2.jpg`, `${process.env.PUBLIC_URL}/images_news/ASC2025_3.jpg`] },
                { date: "2025-08-11", title: "[Announcement] Workshop at Osaka Expo Kurage Pavilion on Aug 24", summary: "Will hold a workshop on plants at the 'Playground of Life: Kurage Pavilion' at the Osaka-Kansai Expo 2025 on August 24.", fullContent: "On Sunday, August 24, 2025, I will be hosting a workshop that I have planned and will guide, titled 'A Symbiotic Landscape Woven by Plants and People - Learning Plant Abilities Through Touch,' at the 'Playground of Life: Kurage Pavilion' of the Osaka-Kansai Expo.\n\nThis project is a participatory event where you can intuitively experience the surprising abilities of plants by seeing and touching them. The venue will feature five stations based on my research, including 'Mimosa Petting,' 'Nyctinasty Observation,' and 'Electrical Signal Visualization.' I hope to create a vision of a future where humans and plants coexist and co-create, by having participants discover the mysteries of plants as they freely tour these stations.\n\nWe sincerely look forward to your visit.\n\n[Event Details]\n■ Date & Time: August 24, 2025 (Sun) 10:15 - 13:15\n■ Location: Osaka-Kansai Expo 2025, Playground of Life: Kurage Pavilion 'Inochi no Yuragi-ba'\n■ How to Participate: No reservation required (first-come, first-served)\n\n*Please note that the event details are subject to change or cancellation depending on the situation.", "images": [ "/images_news/Expo2025_1.jpg", "/images_news/Expo2025_2.jpg" ] }
            ],
            view_more_button: "VIEW ALL",
        ...
        research: {
            title: "Research & Awards",
            description: "An overview of major awards and research grants related to my research activities.",
            awards: [
                { year: "2024", title: "Science Castle Research Grant", prize: "THK Award", details: "Awarded for the research theme 'Automated and High-Precision Quantification of Mimosa Pudica Leaf Opening/Closing by Plant Phenotyping and Development of a Vibration Device.' Received support for developing essential experimental equipment." },
                { year: "2024", title: "Science Castle Research Grant", prize: "Value Co-creation Award (Daicel)", details: "Awarded for the research theme 'Chemical Elucidation of the Memory Mechanism for Stimuli in Mimosa Pudica.' The grant is expected to advance the research through a chemical approach." },
                { year: "2023", title: "1st Learning Co-creation Contest", prize: "Juichi Yamagiwa Award", details: "The results of my research on the circadian rhythm of Mimosa pudica and the depth of learning throughout the research process were highly evaluated, leading me to become one of the inaugural winners." },
                { year: "2022 & 2023", title: "Nagano Prefecture Student Science Award", prize: "Governor's Prize", details: "Received the Governor's Prize, the highest award, for two consecutive years for research on the nyctinastic movement of Mimosa pudica (2022 & 2023). Both studies were recommended to the national competition as representatives of Nagano." },
            ...
            publications: [
                ...
                { title: "Physiological Study of the Adaptation Mechanism to Stimuli in Mimosa pudica", journal: "Annual Meeting of the Japanese Society of Plant Physiologists 2025", year: 2025, pdf: "", type: "Poster Presentation", details: "Physiologically elucidating the stimulus habituation mechanism in Mimosa pudica through adaptation verification via training, internal structure observation, and ion channel analysis. This research explores the selective recognition mechanisms that contribute to energy conservation." },
        ...
        projects: {
            ...
            items: [
                ...
                { image: `${process.env.PUBLIC_URL}/images/hydra.png`, title: "Elucidating Classical Conditioning in Hydra", description: "Investigating whether classical conditioning, a type of learning, exists in Hydra vulgaris, which has a simple diffuse nervous system.", period: "Apr 2025 - Present", details: "This study aims to verify whether the brainless Hydra vulgaris exhibits associative learning (classical conditioning). By repeatedly pairing reduced glutathione (unconditioned stimulus), which induces feeding behavior, with blue light (conditioned stimulus), which causes body contraction, we will use AI-based behavioral analysis to assess whether feeding behavior is subsequently induced by blue light alone. This research delves into the evolutionary origins of learning ability and explores the potential of Hydra as a new model organism in neuroscience." }
            ]
        },
        map: {
            title: "Global Activity Map",
            ...
            locations: [
                ...
                { id: "thailand", name: "Thailand", image: `${process.env.PUBLIC_URL}/images/asc2025.png`, details: "Participated in 'Asia Science Camp 2025' as a member of the Japanese delegation. I deepened my international perspective and personal connections through scientific discussions and interactions with students and Nobel laureates from across Asia." }
            ]
        },
        activities: {
            title: "Activities & Involvements",
                    ...
                    <div className="relative w-full max-w-6xl mx-auto aspect-video bg-gray-100 rounded-lg p-2 border border-gray-200">
                        ...
                        {currentContent.map.locations.map(loc => {
                            const coords = { 
                                ...
                                "thailand": { x: 38, y: 48 } // Thailand coordinates added
                            };

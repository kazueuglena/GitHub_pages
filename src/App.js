...
const content = {
    ja: {
        ...
        news: {
            title: "News",
            items: [
                { date: "2025-07-15", title: "ポートフォリオサイトを大幅リニューアル！", summary: "インタラクティブな機能を追加し、ウェブサイトを全面的に更新しました。", fullContent: "本日、ポートフォリオサイトを大幅にリニューアルしました。これまでの活動内容の拡充に加え、新たにNewsセクション、インタラクティブな活動マップなどを追加しました。これにより、私の活動の現在・過去・未来をより深く、そして楽しく知っていただけるようになったと信じています。ぜひサイト内を探索してみてください。<br><br><a href='https://sites.google.com/view/kazuhirokomatsu' target='_blank' rel='noopener noreferrer' class='text-emerald-600 hover:underline'>以前のサイトはこちら</a>", images: ["/images_news/new_website.png", "/images_news/new_website2.png", "/images_news/new_website3.png"] },
                { date: "2025-07-11", title: "ACMB-JSMB2025にてポスター発表を行いました", summary: "ACMB-JSMB2025にて、植物の刺激馴化メカニズムに関する研究成果をポスター発表しました。", fullContent: "ACMB-JSMB2025（Asian Conference on Mathematical Biology と Annual Meeting of Japanese Society for Mathematical Biology の合同会議）にて、私の研究テーマであるオジギソウの刺激馴化メカニズムに関するポスター発表を行いました。この合同会議は、数理生物学の分野におけるアジア地域および日本の最先端の研究が一堂に会する重要な学術イベントです。\n発表では、植物が環境刺激にどのように適応し、その応答を変化させるのかというメカニズムについて、数理的なアプローチやモデル構築を通じて得られた新たな知見を共有しました。特に、オジギソウの「記憶」とも言える刺激馴化現象を、数理モデルを用いて解析した成果について、参加された研究者の方々と活発な議論を行うことができ、非常に有意義な時間となりました。", images: ['/images_news/ACMBJSMB1.jpg', '/images_news/ACMBJSMB2.jpg'] },
            ],
        ...
        research: {
            ...
            publications: [
                { title: "The Evolutionary and Ecological Significance of Stimulus-Specific Habituation in Mimosa pudica L. A Mathematical Modeling Approach", journal: "ACMB-JSMB2025", year: 2025, pdf: "/materials/poster-acmb-jsmb2025.pdf", type: "ポスター発表", details: "オジギソウの刺激馴化が持つ進化生態学的な意義を、数理モデルを用いて評価しました。特に、馴化がエネルギー消費削減に効果的な適応戦略であること、そして刺激誤認識のリスクが高い状況下で最適な防御戦略となることを、モデルの妥当性を検証しつつ示しました。"},
                { title: "オジギソウ (Mimosa Pudica L.) における刺激特異的馴化の進化生態学的意義: 数理モデルを用いた解析", journal: "N高校研究部紀要2025", year: 2025, pdf: "/materials/paper-n-high-2025.pdf", type: "紀要", details: "オジギソウの刺激馴化がエネルギー効率を高め、生存に不可欠であることを数理モデルで定量的に解析しました。不要な応答コストを抑制し、長期的なエネルギー蓄積に貢献する馴化の適応的意義を明らかにしています。" },
                ...
                { title: "深層学習を用いたミドリムシの動き方の定量化によるステップアップ・ダウン光驚動反応の解明", journal: "サイエンスキャッスル関東大会", year: 2023, pdf: "/materials/poster-euglena-2023.pdf", type: "ポスター発表", details: "オジギソウ研究の原点となった、単細胞生物ユーグレナの光に対する行動と体内時計の関係性を探った初期の研究成果です。" }
            ]
        },
        projects: {
            ...
            items: [
                { image: "/images/mimosa_hab.jpg", title: "オジギソウの刺激特異的馴化機構の解明", description: "オジギソウの刺激に対する順応能力（慣れ）を独自開発した期間度定量化技術と全方位刺激装置により研究しています。", period: "24年3月~継続中", details: "オジギソウが特定の刺激に対して「慣れる」現象、すなわち刺激馴化のメカニズム解明を目指しています。独自に開発した全方位刺激装置と、深層学習を用いた画像解析技術を組み合わせることで、刺激の方向や強度と馴化の関係性を定量的に評価します。将来的には、この能力がどのようなメカニズムで維持されているのかを明らかにします。" },
                { image: "/images/mimosa.jpg", title: "オジギソウの就眠運動（概日リズム）", description: "オジギソウの概日リズムをその一つの出力系である就眠運動を観察することで研究しています。", period: "21年4月~24年2月", details: "植物が持つ体内時計（概日リズム）の出力の一つとして、夜間に葉を閉じる「就眠運動」に着目。深層学習を用いて24時間体制で葉の開閉度を自動定量化するシステムを構築しました。これにより、オジギソウが日没を予測して葉を閉じ始める行動や、光強度に応じて開度を微調整する様子を明らかにしました。" },
                { image: "/images/science.png", title: "サイエンス出前便", description: "地方と都市部の教育格差を是正し、子供たちが科学に触れ合う機会を増やすため科学教室を企画しています。", period: "24年11月~継続中", details: "自身の経験から地方における科学教育の機会格差に問題意識を持ち、立ち上げたプロジェクトです。長野県内の小学生を対象に、身近な自然をテーマにした科学教室を企画・運営。観察や実験を通じて、子どもたちの知的好奇心を引き出し、科学の面白さを伝える活動を継続的に行っています。" },
                { image: "/images/hydra.png", title: "ヒドラにおける古典的条件付けの解明", description: "単純な散在神経系を持つHydra vulgarisにおいて、学習の一種である古典的条件付けが存在するのかを検証しています", period: "25年4月~継続中", details: "本研究は、脳を持たないヒドラ（Hydra vulgaris）が連合学習（古典的条件付け）を示すかを検証します。採食行動を引き起こす還元型グルタチオン（無条件刺激）と、体収縮を誘発する青色光（条件刺激）を繰り返し対提示し、その後、青色光のみで採食行動が誘発されるかをAIを用いた行動解析により評価します。これにより、学習能力の進化的起源に迫り、ヒドラの神経科学における新たなモデル生物としての可能性を探ります。" }
            ]
        },
        map: {
            ...
            locations: [
                { id: "san-francisco", name: "米国 サンフランシスコ", image: "/images/san.jpg", details: "「ながの視察団 AOKI咸臨丸」の一員として訪問。1週間の滞在期間中、ベンチャーキャピタルや元駐日大使との面談など、貴重な経験を積みました。" },
                { id: "utah", name: "米国 ユタ州", image: "/images/utah.png", details: "小学5年生の時、1ヶ月間のホームステイを経験。初めての海外で大きなカルチャーショックを受け、国際的な視野を広げるきっかけとなりました。" },
                { id: "shanghai", name: "中国 上海", image: "/images/shanghai.jpg", details: "中学3年生の時、2週間の学校寮滞在を経験。現地の有名観光地を訪れると共に、学校の授業に参加し、文化交流を深めました。" },
                { id: "singapore", name: "シンガポール", image: "/images/singapore.png", details: "中学3年生の時、2週間のホームステイを経験。ムスリムのホストファミリーとの交流を通じて、文化的な違いを乗り越え、互いの理解を深めました。" }
            ]
        },
        activities: {
            ...
            site_button: "公式サイト",
            items: [
                { image: "/images/SPICE_entre.png", year: "2024-2025", title: "Stanford e-Entrepreneurship", event: "日本中から集まった高校生と英語で講義を受け、教育や健康分野に関して共同でプレゼンテーションを行った。", details: "スタンフォード大学の講師陣によるオンライン講義を通じて、起業家精神やビジネスプランニングの基礎を学びました。最終的には、教育格差問題に取り組むためのプロジェクトをチームで立案し、英語で発表しました。", link: "https://spice.fsi.stanford.edu/fellowship/stanford-e-entrepreneurship-japan" },
                { image: "/images/SPICE.png", year: "2025", title: "Stanford e-Japan", event: "日本中から集まった高校生と英語でStanford大学の教員から日米同盟などに関して教育を受け、英語でディスカッションをした。", details: "日米関係の専門家による講義を受け、外交、文化、経済など多角的な視点から日米関係について学びました。他の参加者との英語でのディスカッションを通じて、国際的な視野と議論のスキルを深めました。", link: "https://spice.fsi.stanford.edu/fellowship/stanford-e-japan" },
                { image: "/images/n1.png", year: "2024-2025", title: "エヌイチ道場 5期生", event: "科学教育プログラムに関して、ビジョンにつながる想いの深堀から、顧客開拓、事業計画立案などを行ったほか、起業家精神を学んだ。", details: "自身の「サイエンス出前便」プロジェクトを事業として発展させるため、メンターの指導のもと、事業計画の策定、ターゲット顧客の分析、収益モデルの検討など、実践的な起業プロセスを学びました。", link: "https://www.sunaba.org/n1dojo" },
                { image: "/images/UTokyo.jpg", year: "2024-", title: "UTokyoGSC-NEXT 6期生", event: "東京大学生産技術研究所が主催するSTEAM教育プログラム。全国から集まった高校生とともに、東大の先生方の講義を受けディスカッションを行った。", details: "東京大学の教授陣から最先端の科学技術に関する講義を受け、自身の研究テーマを深める機会を得ました。全国から集まった意欲の高い同世代の仲間と交流し、大きな刺激を受けています。", link: "https://gsc.iis.u-tokyo.ac.jp/" },
                { image: "/images/advancelab.png", year: "2024-", title: "ADvance Lab 1期生", event: "次世代のための次世代による研究所であるADvance Labのメンバーとして、企画検討や企業訪問、また研究を行った。", details: "現在は副所長として、ラボの運営にも関わっています。次世代と企業をつなぎ新たな価値を創造するとともに、地方におけるイベントなども企画し研究の輪を広げています。", link: "https://adlab.lne.st/" },
                { image: "/images/aoki.png", year: "2022-2023", title: "ながの視察団 AOKI咸臨丸 7期生", event: "AOKI財団が主催する中学生を対象にしたリーダーシップ研修プログラムに参加しました。毎月のリーダーシップに関する講義や2度の国内研修、シリコンバレーにおける起業家プログラムなどを通し、リーダーシップやFail Firstの精神を学びました。", details: "中学生の時に参加したこのプログラムが、現在の活動の原点の一つです。シリコンバレーでの研修では、失敗を恐れずに挑戦する文化に触れ、自身の行動指針に大きな影響を受けました。", link: "https://aoki-zaidan.or.jp/srv_kanrin.php" },
                { image: "/images/Tsukuba.png", year: "2021-2022", title: "つくばSKIPアカデミー", event: "筑波大学の数理陣の授業をオンラインで受け、科学的素養を磨いた。また、そのつながりで研究室を訪問した。", details: "オンラインで大学レベルの数学や物理学に触れることで、科学研究に必要な論理的思考の基礎を固めました。この時の経験が、現在の研究で数理モデルを扱う上での助けとなっています。", link: "https://skip.tsukuba.ac.jp/" }
            ]
        },
        contact: {
            title: "Get In Touch",
    ...
    en: {
        ...
        research: {
            ...
            publications: [
                ...
                { title: "Elucidation of Step-up/Down Photo-shock Response by Quantifying Euglena Movement Using Deep Learning", journal: "Science Castle Kanto Conference", year: 2023, pdf: "/materials/poster-euglena-2023.pdf", type: "Poster Presentation", details: "This is the initial research that became the starting point for the Mimosa pudica study, exploring the relationship between the behavior of the single-celled organism Euglena towards light and its internal clock." }
            ]
        },
        projects: {
            title: "Ongoing & Main Projects",
        ...
        map: {
            ...
            locations: [
                { id: "san-francisco", name: "San Francisco, USA", image: "/images/san.jpg", details: "Visited as a member of the 'Nagano Delegation AOKI Kanrinmaru.' During the one-week stay, I had valuable experiences, including meetings with venture capitalists and the former U.S. Ambassador to Japan." },
                { id: "utah", name: "Utah, USA", image: "/images/utah.png", details: "Experienced a one-month homestay in the 5th grade. It was my first time abroad, which gave me a major culture shock and broadened my international perspective." },
                { id: "shanghai", name: "Shanghai, China", image: "/images/shanghai.jpg", details: "Experienced a two-week stay in a school dormitory in my third year of junior high. I visited famous local tourist spots and participated in school classes, deepening cultural exchange." },
                { id: "singapore", name: "Singapore", image: "/images/singapore.png", details: "Experienced a two-week homestay in my third year of junior high. Through interaction with my Muslim host family, I overcame cultural differences and deepened our mutual understanding." }
            ]
        },
        activities: {
            title: "Activities & Involvements",
            ...
            <>
                ...
                <ContentSection id="map" title={currentContent.map.title} bgColor="bg-slate-50">
                    ...
                    <div className="relative w-full max-w-6xl mx-auto aspect-video bg-gray-100 rounded-lg p-2 border border-gray-200">
                        <img src="/images/map.png" alt="World Map" className="w-full h-full object-contain" />
